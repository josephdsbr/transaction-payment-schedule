package com.shaman.transactionpaymentschedule.exception.handler;

import com.shaman.transactionpaymentschedule.exception.ApplicationException;
import com.shaman.transactionpaymentschedule.exception.ApplicationInternalException;
import com.shaman.transactionpaymentschedule.message.ApplicationMessage;
import com.shaman.transactionpaymentschedule.message.Messages;
import com.shaman.transactionpaymentschedule.util.LoggerUtil;
...
public class GlobalExceptionHandler {
    ...
    public Map<String, List<ApplicationMessage>> handleConstraintViolationException(ConstraintViolationException ex) {
        List<ApplicationMessage> messages = ex.getConstraintViolations()
                .stream()
